    ...
    <>
     ...
     {/* mobile cart button */}
      ...
      {/* mobile - magnifier icon to open search bar */}
        <div style={{ color: "white" }} className="magnifierIcon" onClick={() => setsearchBarDisplay(!searchBarDisplay)}>
        ...
        <div className={`searchBarMobile${searchBarDisplay ? "" : '2'}`} >
          <div className="closeSearchMobile" onClick={() => setsearchBarDisplay(!searchBarDisplay)}> X</div>
          <SearchBar></SearchBar>
        </div>
