      ...
      <div className={`main_wrapper ${!flag && 'disabled_main_wrapper'}`}>
        ...
        <div className='info_wrapper'>
          ...
          <div className='info_box_chqout' onClick={() => {
            ...
            <svg xmlns="http://www.w3.org/2000/svg" width="37" height="37" fill="currentColor" class="bi bi-truck" viewBox="0 0 16 16">
          ...
          <div className='info_box_chqout' >
            ...
            <svg xmlns="http://www.w3.org/2000/svg" width="37" height="37" fill="currentColor" class="bi bi-credit-card" viewBox="0 0 16 16">
